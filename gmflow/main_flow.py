...
import sys
sys.path.append('/home/moon/vivit_model/vivit/gmflow')
...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='gmflow/pretrained/gmflow-scale2-regrefine6-mixdata-train320x576-4e7b215d.pth', type=str,
