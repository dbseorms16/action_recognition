...
from vivit2 import ViViT,ClassificationHead,UniMatch
...
num_classes = 101
dataset_root_path = '/home/moon/vivit_model/ii/'
...
if __name__ == "__main__":
    ...
    net.load_state_dict(torch.load("/home/moon/vivit_model/UCF101_0.9053.pth"))
    net.to(device)
    ...
    for epoch in range(epoch):  # loop over the dataset multiple times
        ...
        for i, data in enumerate(train_dataloader, 0):
            ...
            if i % 500 == 499:    # print every 2000 mini-batches
                writer.add_scalar("Loss/train_iter", running_loss/ 500, (epoch+1)*i)
        ...
        if (epoch+1) % 10 == 0:   
            ...
            with torch.no_grad():
                ...
                writer.add_scalar("top1/epoch", total_acc, (epoch+1))
